! function (e, t) {
  ...
  return function (e) {
    ...
    var r = n(0),
      ...
      i = function () {
        ...
        return e.RegisterExtension = function (t, n) {
          e.UnregisterExtension(t) && r.Tools.Warn("Extension with the name '" + t + "' already exists"), e._ExtensionFactories[t] = n, e._ExtensionNames.push(t)
        }, e.UnregisterExtension = function (t) {
          if (!e._ExtensionFactories[t]) return !1;
          delete e._ExtensionFactories[t];
          var n = e._ExtensionNames.indexOf(t);
          return -1 !== n && e._ExtensionNames.splice(n, 1), !0
          ...
          if (!this._disposed) {
            ...
            for (var n in this._requests.length = 0, this._completePromises.length = 0, this._extensions) {
              this._extensions[n].dispose && this._extensions[n].dispose()
            }
            this._extensions = {}, delete this._gltf, delete this._babylonScene, delete this._rootBabylonMesh, delete this._progressCallback, this._parent._clear()
          }
        }, e.prototype.importMeshAsync = function (e, t, n, r, o, a) {
          var i = this;
          return Promise.resolve().then(function () {
            i._babylonScene = t, i._rootUrl = r, i._fileName = a || "scene", i._progressCallback = o, i._loadData(n);
            var s = null;
            if (e) {
              var l = {};
              if (i._gltf.nodes)
                for (var u = 0, c = i._gltf.nodes; u < c.length; u++) {
                  var f = c[u];
                  f.name && (l[f.name] = f.index)
                }
              s = (e instanceof Array ? e : [e]).map(function (e) {
                var t = l[e];
                if (void 0 === t) throw new Error("Failed to find node '" + e + "'");
                return t
              })
            }
            return i._loadAsync(s, function () {
              return {
                meshes: i._getMeshes(),
                particleSystems: [],
                skeletons: i._getSkeletons(),
                animationGroups: i._getAnimationGroups()
              }
            })
          })
          ...
          var a = this;
          return Promise.resolve().then(function () {
            return a._babylonScene = e, a._rootUrl = n, a._fileName = o || "scene", a._progressCallback = r, a._loadData(t), a._loadAsync(null, function () {})
          })
          ...
          return Promise.resolve().then(function () {
            ...
            var f = Promise.all(l).then(function () {
              return n._rootBabylonMesh && n._rootBabylonMesh.setEnabled(!0), n._setState(o.GLTFLoaderState.READY), n._extensionsOnReady(), n._startAnimations(), t()
            });
          ...
          if (this._gltf = e.json, this._setupData(), e.bin) {
            ...
            if (t && t[0] && !t[0].uri) {
              var n = t[0];
              (n.byteLength < e.bin.byteLength - 3 || n.byteLength > e.bin.byteLength) && r.Tools.Warn("Binary buffer length (" + n.byteLength + ") from JSON does not match chunk length (" + e.bin.byteLength + ")"), n._data = Promise.resolve(e.bin)
            } else r.Tools.Warn("Unexpected BIN chunk")
          }
          ...
          if (a.Assign(this._gltf.accessors), a.Assign(this._gltf.animations), a.Assign(this._gltf.buffers), a.Assign(this._gltf.bufferViews), a.Assign(this._gltf.cameras), a.Assign(this._gltf.images), a.Assign(this._gltf.materials), a.Assign(this._gltf.meshes), a.Assign(this._gltf.nodes), a.Assign(this._gltf.samplers), a.Assign(this._gltf.scenes), a.Assign(this._gltf.skins), a.Assign(this._gltf.textures), this._gltf.nodes) {
            for (var e = {}, t = 0, n = this._gltf.nodes; t < n.length; t++) {
              if ((u = n[t]).children)
                for (var r = 0, o = u.children; r < o.length; r++) {
                  e[o[r]] = u.index
                }
            }
            for (var i = this._createRootNode(), s = 0, l = this._gltf.nodes; s < l.length; s++) {
              var u, c = e[(u = l[s]).index];
              u.parent = void 0 === c ? i : this._gltf.nodes[c]
            }
          }
        }, e.prototype._loadExtensions = function () {
          for (var t = 0, n = e._ExtensionNames; t < n.length; t++) {
            var r = n[t],
              o = e._ExtensionFactories[r](this);
            this._extensions[r] = o, this._parent.onExtensionLoadedObservable.notifyObservers(o)
          }
          this._parent.onExtensionLoadedObservable.clear()
        }, e.prototype._checkExtensions = function () {
          if (this._gltf.extensionsRequired)
            for (var e = 0, t = this._gltf.extensionsRequired; e < t.length; e++) {
              var n = t[e],
          ...
          this._rootBabylonMesh = new r.Mesh("__root__", this._babylonScene), this._rootBabylonMesh.setEnabled(!1);
          var t = {
          ...
          if (this.logOpen(e + " " + (t.name || "")), t.nodes)
            for (var i = 0, s = t.nodes; i < s.length; i++) {
              var l = s[i],
          ...
          if (this._gltf.nodes)
            for (var c = 0, f = this._gltf.nodes; c < f.length; c++) {
              if ((u = f[c])._babylonTransformNode && u._babylonBones)
                for (var d = 0, h = u._babylonBones; d < h.length; d++) {
                  h[d].linkTransformNode(u._babylonTransformNode)
                }
            }
          ...
          if (e._primitiveBabylonMeshes)
            for (var n = 0, r = e._primitiveBabylonMeshes; n < r.length; n++) {
              t(r[n])
            }
          ...
          switch (this._parent.animationStartMode) {
            ...
            case o.GLTFLoaderAnimationStartMode.ALL:
              ...
              break;
            default:
              return void r.Tools.Error("Invalid animation start mode (" + this._parent.animationStartMode + ")")
          }
          ...
          var u = function (r) {
            ...
            if (n.children)
              for (var u = 0, c = n.children; u < c.length; u++) {
                var f = c[u],
                  d = a.Get(t + "/children/" + f, i._gltf.nodes, f);
                l.push(i.loadNodeAsync("/nodes/" + d.index, d, function (e) {
                  e.parent = r
                }))
              }
            o(r)
          ...
          if (null == n.mesh) {
            ...
            n._babylonTransformNode = new r.TransformNode(c, this._babylonScene), u(n._babylonTransformNode)
          } else {
            var f = a.Get(t + "/mesh", this._gltf.meshes, n.mesh);
            l.push(this._loadMeshAsync("/meshes/" + f.index, n, f, u))
          }
          ...
          if (1 === i.length) {
            ...
            t._babylonTransformNode = new r.TransformNode(l, this._babylonScene), t._primitiveBabylonMeshes = [];
          ...
          if (null != t.skin) {
            var d = a.Get(e + "/skin", this._gltf.skins, t.skin);
            s.push(this._loadSkinAsync("/skins/" + d.index, t, d))
          }
          ...
          if (c) return c;
          this.logOpen("" + t);
          var f, d, h = null == o.skin && !i.primitives[0].targets,
            p = s._instanceData;
          if (h && p) f = p.babylonSourceMesh.createInstance(n), d = p.promise;
          else {
            var m = new Array,
              _ = new r.Mesh(n, this._babylonScene);
            this._createMorphTargets(t, o, i, s, _), m.push(this._loadVertexDataAsync(t, s, _).then(function (e) {
              return u._loadMorphTargetsAsync(t, s, _, e).then(function () {
                e.applyToMesh(_)
              })
            }));
            var y = e._GetDrawMode(t, s.mode);
            if (null == s.material) {
              var v = this._defaultBabylonMaterialData[y];
              v || (v = this._createDefaultMaterial("__GLTFLoader._default", y), this._parent.onMaterialLoadedObservable.notifyObservers(v), this._defaultBabylonMaterialData[y] = v), _.material = v
            } else {
              var A = a.Get(t + "/material", this._gltf.materials, s.material);
              m.push(this._loadMaterialAsync("/materials/" + A.index, A, _, y, function (e) {
                _.material = e
              }))
            }
            d = Promise.all(m), h && (s._instanceData = {
              babylonSourceMesh: _,
              promise: d
            }), f = _
          }
          return e.AddPointerMetadata(f, t), this._parent.onMeshLoadedObservable.notifyObservers(f), l(f), this.logClose(), d.then(function () {
            return f
          })
          ...
          var f = function (t, r, i) {
            if (null != s[t]) {
              ...
              var c = a.Get(e + "/attributes/" + t, o._gltf.accessors, s[t]);
              l.push(o._loadVertexAccessorAsync("/accessors/" + c.index, c, r).then(function (e) {
                u.setVerticesBuffer(e, c.count)
              })), i && i(c)
            }
          };
          return f("POSITION", r.VertexBuffer.PositionKind), f("NORMAL", r.VertexBuffer.NormalKind), f("TANGENT", r.VertexBuffer.TangentKind), f("TEXCOORD_0", r.VertexBuffer.UVKind), f("TEXCOORD_1", r.VertexBuffer.UV2Kind), f("JOINTS_0", r.VertexBuffer.MatricesIndicesKind), f("WEIGHTS_0", r.VertexBuffer.MatricesWeightsKind), f("COLOR_0", r.VertexBuffer.ColorKind, function (e) {
          ...
          if (o.targets) {
            if (null == t._numMorphTargets) t._numMorphTargets = o.targets.length;
            else if (o.targets.length !== t._numMorphTargets) throw new Error(e + ": Primitives do not have the same number of targets");
            a.morphTargetManager = new r.MorphTargetManager(a.getScene());
            for (var i = 0; i < o.targets.length; i++) {
              var s = t.weights ? t.weights[i] : n.weights ? n.weights[i] : 0;
              a.morphTargetManager.addTarget(new r.MorphTarget("morphTarget" + i, s, a.getScene()))
            }
          }
          ...
          if (null == e.skin) {
            var n = r.Vector3.Zero(),
              ...
              a = r.Vector3.One();
            if (e.matrix) r.Matrix.FromArray(e.matrix).decompose(a, o, n);
            else e.translation && (n = r.Vector3.FromArray(e.translation)), e.rotation && (o = r.Quaternion.FromArray(e.rotation)), e.scale && (a = r.Vector3.FromArray(e.scale));
          ...
          var s = "skeleton" + n.index,
            l = new r.Skeleton(n.name || s, s, this._babylonScene);
          l.overrideMesh = this._rootBabylonMesh, this._loadBones(e, n, l), i(l);
          ...
          for (var n = 0, o = e.bones; n < o.length; n++) {
            ...
            var l = a.getParent();
            l && i.multiplyToRef(l.getInvertedAbsoluteTransform(), i), a.updateMatrix(i, !1, !1), a._updateDifferenceMatrix(void 0, !1)
          }
          ...
          switch (s.rotation = new r.Vector3(0, Math.PI, 0), n.type) {
            case "perspective":
              var l = n.perspective;
          ...
          return e.AddPointerMetadata(s, t), this._parent.onCameraLoadedObservable.notifyObservers(s), o(s), Promise.all(i).then(function () {
            return s
          })
          ...
          return this._loadAnimationSamplerAsync(t + "/samplers/" + o.sampler, c).then(function (t) {
            ...
            switch (n) {
              case "position":
                c = function () {
                  var e = r.Vector3.FromArray(t.output, d);
                  return d += 3, e
                };
                break;
              case "rotationQuaternion":
                c = function () {
                  var e = r.Quaternion.FromArray(t.output, d);
                  return d += 4, e
                };
                break;
              case "scaling":
              ...
              case "influence":
                c = function () {
                  for (var e = new Array(u._numMorphTargets), n = 0; n < u._numMorphTargets; n++) e[n] = t.output[d++];
                  return e
                }
            }
            ...
            for (var h = new Array(t.input.length), p = 0; p < t.input.length; p++) h[p] = f(p);
            if ("influence" === n)
              for (var m = function (e) {
                ...
                }, _ = 0; _ < u._numMorphTargets; _++) m(_);
            else {
              var y = i.name + "_channel" + i.targetedAnimations.length,
                v = new r.Animation(y, n, 1, a);
              v.setKeys(h), null != s && null != s.animations ? (s.animations.push(v), i.addTargetedAnimation(v, s)) : (u._babylonTransformNode.animations.push(v), i.addTargetedAnimation(v, u._babylonTransformNode))
            }
          })
        ...
        }, e.prototype._loadBufferAsync = function (e, t) {
          if (t._data) return t._data;
          if (!t.uri) throw new Error(e + "/uri: Value is missing");
          return t._data = this.loadUriAsync(e + "/uri", t, t.uri), t._data
        }, e.prototype.loadBufferViewAsync = function (e, t) {
          if (t._data) return t._data;
          var n = a.Get(e + "/buffer", this._gltf.buffers, t.buffer);
          return t._data = this._loadBufferAsync("/buffers/" + n.index, n).then(function (n) {
            try {
              return new Uint8Array(n.buffer, n.byteOffset + (t.byteOffset || 0), t.byteLength)
            } catch (t) {
          ...
          var r = a.Get(t + "/bufferView", this._gltf.bufferViews, n.bufferView);
          return n._data = this.loadBufferViewAsync("/bufferViews/" + r.index, r).then(function (r) {
            return e._GetTypedArray(t, n.componentType, r, n.byteOffset, n.count)
          }), n._data
        }, e.prototype._loadFloatAccessorAsync = function (t, n) {
          var r = this;
          if (5126 !== n.componentType) throw new Error("Invalid component type " + n.componentType);
          if (n._data) return n._data;
          var o = e._GetNumComponents(t, n.type),
            i = o * n.count;
          if (null == n.bufferView) n._data = Promise.resolve(new Float32Array(i));
          else {
            var s = a.Get(t + "/bufferView", this._gltf.bufferViews, n.bufferView);
            n._data = this.loadBufferViewAsync("/bufferViews/" + s.index, s).then(function (r) {
              return e._GetTypedArray(t, n.componentType, r, n.byteOffset, i)
            })
          }
          if (n.sparse) {
            var l = n.sparse;
            n._data = n._data.then(function (i) {
              var s = i,
                u = a.Get(t + "/sparse/indices/bufferView", r._gltf.bufferViews, l.indices.bufferView),
                c = a.Get(t + "/sparse/values/bufferView", r._gltf.bufferViews, l.values.bufferView);
              return Promise.all([r.loadBufferViewAsync("/bufferViews/" + u.index, u), r.loadBufferViewAsync("/bufferViews/" + c.index, c)]).then(function (r) {
                for (var a = r[0], i = r[1], u = e._GetTypedArray(t + "/sparse/indices", l.indices.componentType, a, l.indices.byteOffset, l.count), c = e._GetTypedArray(t + "/sparse/values", n.componentType, i, l.values.byteOffset, o * l.count), f = 0, d = 0; d < u.length; d++)
                  for (var h = u[d] * o, p = 0; p < o; p++) s[h++] = c[f++];
                return s
              })
            })
          }
          ...
          var n = this;
          return e._babylonBuffer ? e._babylonBuffer : (e._babylonBuffer = this.loadBufferViewAsync("/bufferViews/" + e.index, e).then(function (e) {
          ...
          if (n.sparse) n._babylonVertexBuffer = this._loadFloatAccessorAsync("/accessors/" + n.index, n).then(function (e) {
          ...
          else if (n.byteOffset && n.byteOffset % r.VertexBuffer.GetTypeByteLength(n.componentType) != 0) r.Tools.Warn("Accessor byte offset is not a multiple of component type byte length"), n._babylonVertexBuffer = this._loadFloatAccessorAsync("/accessors/" + n.index, n).then(function (e) {
            return new r.VertexBuffer(i._babylonScene.getEngine(), e, o, !1)
          });
          else {
            var s = a.Get(t + "/bufferView", this._gltf.bufferViews, n.bufferView);
            n._babylonVertexBuffer = this._loadVertexBufferViewAsync(s, o).then(function (a) {
              ...
              return new r.VertexBuffer(i._babylonScene.getEngine(), a, o, !1, !1, s.byteStride, !1, n.byteOffset, l, n.componentType, n.normalized, !0)
            })
          }
          ...
          })), t.metallicRoughnessTexture && (o.push(this.loadTextureInfoAsync(e + "/metallicRoughnessTexture", t.metallicRoughnessTexture, function (e) {
          ...
          return s.babylonMeshes.push(r), r.onDisposeObservable.addOnce(function () {
            var e = s.babylonMeshes.indexOf(r); - 1 !== e && s.babylonMeshes.splice(e, 1)
          ...
          return n.sideOrientation = this._babylonScene.useRightHandedSystem ? r.Material.CounterClockWiseSideOrientation : r.Material.ClockWiseSideOrientation, n.fillMode = t, n.enableSpecularAntiAliasing = !0, n.useRadianceOverAlpha = !this._parent.transparencyAsCoverage, n.useSpecularOverAlpha = !this._parent.transparencyAsCoverage, n.transparencyMode = r.PBRMaterial.PBRMATERIAL_OPAQUE, n.metallic = 1, n.roughness = 1, n
          ...
          if (!(n instanceof r.PBRMaterial)) throw new Error(e + ": Material type not supported");
          var o = new Array;
          return n.emissiveColor = t.emissiveFactor ? r.Color3.FromArray(t.emissiveFactor) : new r.Color3(0, 0, 0), t.doubleSided && (n.backFaceCulling = !1, n.twoSidedLighting = !0), t.normalTexture && (o.push(this.loadTextureInfoAsync(e + "/normalTexture", t.normalTexture, function (e) {
          ...
          var s = a.Get(t + "/index", this._gltf.textures, n.index),
            l = this._loadTextureAsync("/textures/" + n.index, s, function (a) {
        ...
        }, e.prototype._loadTextureAsync = function (t, n, o) {
          var i = this;
          void 0 === o && (o = function () {});
          var s = new Array;
          this.logOpen(t + " " + (n.name || ""));
          var l = null == n.sampler ? e._DefaultSampler : a.Get(t + "/sampler", this._gltf.samplers, n.sampler),
            u = this._loadSampler("/samplers/" + l.index, l),
            c = a.Get(t + "/source", this._gltf.images, n.source),
            f = null;
          c.uri && (r.Tools.IsBase64(c.uri) ? f = c.uri : this._babylonScene.getEngine().textureFormatInUse && (f = this._rootUrl + c.uri));
          var d = new r.Deferred,
            h = new r.Texture(f, this._babylonScene, u.noMipMaps, !1, u.samplingMode, function () {
              i._disposed || d.resolve()
            }, function (e, n) {
              i._disposed || d.reject(new Error(t + ": " + (n && n.message ? n.message : e || "Failed to load texture")))
            });
          return s.push(d.promise), f || s.push(this.loadImageAsync("/images/" + c.index, c).then(function (e) {
            var t = c.uri || i._fileName + "#image" + c.index,
              n = "data:" + i._uniqueRootUrl + t;
            h.updateURL(n, new Blob([e], {
              type: c.mimeType
            }))
          })), h.wrapU = u.wrapU, h.wrapV = u.wrapV, o(h), this.logClose(), Promise.all(s).then(function () {
            return h
          })
          ...
          return t._data
        }, e.prototype.loadUriAsync = function (t, n, a) {
          var i = this,
            s = this._extensionsLoadUriAsync(t, n, a);
          if (s) return s;
          if (!e._ValidateUri(a)) throw new Error(t + ": '" + a + "' is invalid");
          if (r.Tools.IsBase64(a)) {
            var l = new Uint8Array(r.Tools.DecodeBase64(a));
            return this.log("Decoded " + a.substr(0, 64) + "... (" + l.length + " bytes)"), Promise.resolve(l)
          }
          return this.log("Loading " + a), this._parent.preprocessUrlAsync(this._rootUrl + a).then(function (e) {
            return new Promise(function (n, s) {
              if (!i._disposed) {
                var l = r.Tools.LoadFile(e, function (e) {
                  if (!i._disposed) {
                    var t = new Uint8Array(e);
                    i.log("Loaded " + a + " (" + t.length + " bytes)"), n(t)
                  }
                }, function (e) {
                  if (!i._disposed && (l && (l._lengthComputable = e.lengthComputable, l._loaded = e.loaded, l._total = e.total), i._state === o.GLTFLoaderState.LOADING)) try {
                    i._onProgress()
                  } catch (e) {
                    s(e)
                  }
                }, i._babylonScene.offlineProvider, !0, function (e, n) {
                  i._disposed || s(new r.LoadFileError(t + ": Failed to load '" + a + "'" + (e ? ": " + e.status + " " + e.statusText : ""), e))
                });
                i._requests.push(l)
              }
            })
          ...
          if (this._progressCallback) {
            for (var e = !0, t = 0, n = 0, o = 0, a = this._requests; o < a.length; o++) {
              var i = a[o];
              if (void 0 === i._lengthComputable || void 0 === i._loaded || void 0 === i._total) return;
              e = e && i._lengthComputable, t += i._loaded, n += i._total
            }
            this._progressCallback(new r.SceneLoaderProgressEvent(e, t, e ? n : 0))
          }
          ...
          switch (t = null == t ? 10497 : t) {
            ...
            default:
              return r.Tools.Warn(e + ": Invalid value (" + t + ")"), r.Texture.WRAP_ADDRESSMODE
          }
          ...
          if (9729 === n) switch (o) {
            ...
            default:
              return r.Tools.Warn(e + "/minFilter: Invalid value (" + o + ")"), r.Texture.LINEAR_LINEAR_MIPLINEAR
          } else switch (9728 !== n && r.Tools.Warn(e + "/magFilter: Invalid value (" + n + ")"), o) {
            case 9728:
            ...
            default:
              return r.Tools.Warn(e + "/minFilter: Invalid value (" + o + ")"), r.Texture.NEAREST_NEAREST_MIPNEAREST
          }
        }, e._GetTypedArray = function (e, t, n, r, o) {
          var a = n.buffer;
          r = n.byteOffset + (r || 0);
          try {
            switch (t) {
          ...
          if (this._gltf.materials)
            for (var n = 0, r = this._gltf.materials; n < r.length; n++) {
              var o = r[n];
              if (o._data)
          ...
          for (var n = 0, r = e._ExtensionNames; n < r.length; n++) {
            var o = r[n],
              a = this._extensions[o];
            a.enabled && t(a)
          }
        }, e.prototype._applyExtensions = function (t, n, r) {
          for (var o = 0, a = e._ExtensionNames; o < a.length; o++) {
            var i = a[o],
              s = this._extensions[i];
            if (s.enabled) {
              var l = i + "." + n,
                u = t;
              u._activeLoaderExtensionFunctions = u._activeLoaderExtensionFunctions || {};
              var c = u._activeLoaderExtensionFunctions;
              if (!c[l]) {
                c[l] = !0;
                try {
                  var f = r(s);
    ...
    var s = function () {
        function e() {
          this.onParsedObservable = new i.Observable, this.coordinateSystemMode = r.AUTO, this.animationStartMode = o.FIRST, this.compileMaterials = !1, this.useClipPlane = !1, this.compileShadowGenerators = !1, this.transparencyAsCoverage = !1, this.preprocessUrlAsync = function (e) {
        ...
        return Object.defineProperty(e.prototype, "onParsed", {
          ...
          var i = this;
          return this._parseAsync(t, n, r, a).then(function (n) {
            return i._log("Loading " + (a || "")), i._loader = i._getLoader(n), i._loader.importMeshAsync(e, t, n, r, o, a)
          })
        }, e.prototype.loadAsync = function (e, t, n, r, o) {
          var a = this;
          return this._parseAsync(e, t, n, o).then(function (t) {
            return a._log("Loading " + (o || "")), a._loader = a._getLoader(t), a._loader.loadAsync(e, t, n, r, o)
          })
        }, e.prototype.loadAssetContainerAsync = function (e, t, n, r, o) {
          var a = this;
          return this._parseAsync(e, t, n, o).then(function (t) {
            a._log("Loading " + (o || "")), a._loader = a._getLoader(t);
            var s = [];
            a.onMaterialLoadedObservable.add(function (e) {
              s.push(e)
            });
            var l = [];
            return a.onTextureLoadedObservable.add(function (e) {
              l.push(e)
            }), a._loader.importMeshAsync(null, e, t, n, r, o).then(function (t) {
              var n = new i.AssetContainer(e);
              return Array.prototype.push.apply(n.meshes, t.meshes), Array.prototype.push.apply(n.particleSystems, t.particleSystems), Array.prototype.push.apply(n.skeletons, t.skeletons), Array.prototype.push.apply(n.animationGroups, t.animationGroups), Array.prototype.push.apply(n.materials, s), Array.prototype.push.apply(n.textures, l), n.removeAllFromScene(), n
            })
          })
        ...
        }, e.prototype._parseAsync = function (e, t, n, r) {
          var o = this;
          return Promise.resolve().then(function () {
            return o._validateAsync(e, t, n, r).then(function () {
              var e = t instanceof ArrayBuffer ? o._unpackBinary(t) : {
                json: t,
                bin: null
              };
              o._startPerformanceCounter("Parse JSON"), o._log("JSON length: " + e.json.length);
              var n = {
                json: JSON.parse(e.json),
                bin: e.bin
              };
              return o._endPerformanceCounter("Parse JSON"), o.onParsedObservable.notifyObservers(n), o.onParsedObservable.clear(), n
            })
          })
        }, e.prototype._validateAsync = function (e, t, n, r) {
          var o = this;
          if (!this.validate || "undefined" == typeof GLTFValidator) return Promise.resolve();
          this._startPerformanceCounter("Validate JSON");
          var a = {
            externalResourceFunction: function (t) {
              return o.preprocessUrlAsync(n + t).then(function (t) {
                return e._loadFileAsync(t, !0, !0)
              }).then(function (e) {
                return new Uint8Array(e)
              })
            }
          };
          return r && "data:" !== r.substr(0, 5) && (a.uri = "file:" === n ? r : "" + n + r), (t instanceof ArrayBuffer ? GLTFValidator.validateBytes(new Uint8Array(t), a) : GLTFValidator.validateString(t, a)).then(function (e) {
            o._endPerformanceCounter("Validate JSON"), o.onValidatedObservable.notifyObservers(e), o.onValidatedObservable.clear()
          }, function (e) {
            o._endPerformanceCounter("Validate JSON"), i.Tools.Warn("Failed to validate: " + e), o.onValidatedObservable.clear()
          })
          ...
          return a(this)
        }, e.prototype._unpackBinary = function (e) {
        ...
        }, e.prototype._unpackBinaryV1 = function (t) {
          var n = t.readUint32();
          if (n != t.getLength()) throw new Error("Length in header does not match actual data length: " + n + " != " + t.getLength());
          var r, o = t.readUint32(),
            a = t.readUint32();
          switch (a) {
            case 0:
              r = e._decodeBufferToText(t.readUint8Array(o));
              break;
            default:
              throw new Error("Unexpected content format: " + a)
          }
          var i = t.getLength() - t.getPosition();
          return {
            json: r,
            bin: t.readUint8Array(i)
          }
        }, e.prototype._unpackBinaryV2 = function (t) {
          var n = 1313821514,
            r = 5130562,
            o = t.readUint32();
          if (o !== t.getLength()) throw new Error("Length in header does not match actual data length: " + o + " != " + t.getLength());
          var a = t.readUint32();
          if (t.readUint32() !== n) throw new Error("First chunk format is not JSON");
          for (var i = e._decodeBufferToText(t.readUint8Array(a)), s = null; t.getPosition() < t.getLength();) {
            var l = t.readUint32();
            switch (t.readUint32()) {
              case n:
                throw new Error("Unexpected JSON chunk");
              case r:
                s = t.readUint8Array(l);
                break;
              default:
                t.skipBytes(l)
            }
        ...
        }, e._decodeBufferToText = function (e) {
        ...
        }, e.prototype._endPerformanceCounterDisabled = function (e) {}, e.IncrementalLoading = !0, e.HomogeneousCoordinates = !1, e._logSpaces = "                                ", e
      }(),
      l = function () {
        function e(e) {
    ...
    i.SceneLoader && i.SceneLoader.RegisterPlugin(new s)
  }, function (e, t) {
    var n;
    n = function () {
      return this
    ...
    var r = n(0),
      ...
      i = function () {
        function e(e) {
          this.name = a, this.enabled = !0, this._loader = e
        }
        return e.prototype.dispose = function () {
          ...
          if (!t._loaded) {
            ...
            for (var i = new Array(t.specularImages.length), s = function (n) {
              ...
              }, l = this, u = 0; u < t.specularImages.length; u++) s(u);
    ...
    var s = "KHR_draco_mesh_compression",
      l = function () {
        function e(e) {
          this.name = s, this.enabled = r.DracoCompression.DecoderAvailable, this._loader = e
        }
        return e.prototype.dispose = function () {
    ...
    o.b.RegisterExtension(s, function (e) {
      return new l(e)
    });
    var u, c = "KHR_lights_punctual";
    ! function (e) {
      e.DIRECTIONAL = "directional", e.POINT = "point", e.SPOT = "spot"
    }(u || (u = {}));
    var f = function () {
      function e(e) {
        this.name = c, this.enabled = !0, this._loader = e
      }
      return e.prototype.dispose = function () {
        delete this._loader, delete this._lights
      }, e.prototype.onLoading = function () {
        ...
        return o.b.LoadExtensionAsync(e, t, this.name, function (i, s) {
          return a._loader.loadNodeAsync(e, t, function (e) {
            var t, l = o.a.Get(i, a._lights, s.light),
              c = l.name || e.name;
            switch (l.type) {
              case u.DIRECTIONAL:
                t = new r.DirectionalLight(c, r.Vector3.Backward(), a._loader.babylonScene);
                break;
              case u.POINT:
                t = new r.PointLight(c, r.Vector3.Zero(), a._loader.babylonScene);
                break;
              case u.SPOT:
                var f = new r.SpotLight(c, r.Vector3.Zero(), r.Vector3.Backward(), 0, 1, a._loader.babylonScene);
                f.angle = 2 * (l.spot && l.spot.outerConeAngle || Math.PI / 4), f.innerAngle = 2 * (l.spot && l.spot.innerConeAngle || 0), t = f;
                break;
              default:
                throw new Error(i + ": Invalid light type (" + l.type + ")")
            }
            t.falloffType = r.Light.FALLOFF_GLTF, t.diffuse = l.color ? r.Color3.FromArray(l.color) : r.Color3.White(), t.intensity = null == l.intensity ? 1 : l.intensity, t.range = null == l.range ? Number.MAX_VALUE : l.range, t.parent = e, o.b.AddPointerMetadata(t, i), n(e)
          })
        })
      }, e
    }();
    o.b.RegisterExtension(c, function (e) {
      return new f(e)
    });
    var d = "KHR_materials_pbrSpecularGlossiness",
      h = function () {
        function e(e) {
          this.name = d, this.enabled = !0, this._loader = e
        }
        return e.prototype.dispose = function () {
          delete this._loader
        }, e.prototype.loadMaterialPropertiesAsync = function (e, t, n) {
          ...
          })), n.specularGlossinessTexture && (a.push(this._loader.loadTextureInfoAsync(e + "/specularGlossinessTexture", n.specularGlossinessTexture, function (e) {
    ...
    o.b.RegisterExtension(d, function (e) {
      return new h(e)
    });
    var p = "KHR_materials_unlit",
      m = function () {
        function e(e) {
          this.name = p, this.enabled = !0, this._loader = e
        }
        return e.prototype.dispose = function () {
          delete this._loader
        }, e.prototype.loadMaterialPropertiesAsync = function (e, t, n) {
    ...
    o.b.RegisterExtension(p, function (e) {
      return new m(e)
    });
    var _ = "KHR_texture_transform",
      y = function () {
        function e(e) {
          this.name = _, this.enabled = !0, this._loader = e
        }
        return e.prototype.dispose = function () {
          delete this._loader
    ...
    o.b.RegisterExtension(_, function (e) {
      return new y(e)
    });
    var v = "MSFT_audio_emitter",
      A = function () {
        function e(e) {
          this.name = v, this.enabled = !0, this._loader = e
        }
        return e.prototype.dispose = function () {
          ...
          if (t._babylonSounds = t._babylonSounds || [], !t._babylonData) {
            ...
            var f = Promise.all(a).then(function () {
    ...
    o.b.RegisterExtension(v, function (e) {
      return new A(e)
    });
    var b = "MSFT_lod",
      g = function () {
        ...
        return e.prototype.dispose = function () {
          ...
          for (var e = this, t = function (t) {
              var r = Promise.all(n._nodePromiseLODs[t]).then(function () {
                0 !== t && e._loader.endPerformanceCounter("Node LOD " + t), e._loader.log("Loaded node LOD " + t), e.onNodeLODsLoadedObservable.notifyObservers(t), t !== e._nodePromiseLODs.length - 1 && (e._loader.startPerformanceCounter("Node LOD " + (t + 1)), e._nodeSignalLODs[t] && e._nodeSignalLODs[t].resolve())
              });
          ...
          var o = function (t) {
              var n = Promise.all(a._materialPromiseLODs[t]).then(function () {
                0 !== t && e._loader.endPerformanceCounter("Material LOD " + t), e._loader.log("Loaded material LOD " + t), e.onMaterialLODsLoadedObservable.notifyObservers(t), t !== e._materialPromiseLODs.length - 1 && (e._loader.startPerformanceCounter("Material LOD " + (t + 1)), e._materialSignalLODs[t] && e._materialSignalLODs[t].resolve())
              });
          ...
          return o.b.LoadExtensionAsync(e, t, this.name, function (e, n) {
            var o, i = a._getLODs(e, t, a._loader.gltf.nodes, n.ids);
            a._loader.logOpen("" + e);
            for (var s = function (e) {
                ...
                var n = a._loader.loadNodeAsync("#/nodes/" + t.index, t, function (e) {
                  ...
                  if (0 !== e) {
                    var n = i[e - 1];
                    n._babylonTransformNode && (n._babylonTransformNode.dispose(), delete n._babylonTransformNode, a._disposeUnusedMaterials())
                  }
                  return t.setEnabled(!0), t
                });
                0 === e ? o = n : a._nodeIndexLOD = null, a._nodePromiseLODs[e] = a._nodePromiseLODs[e] || [], a._nodePromiseLODs[e].push(n)
          ...
          return this._nodeIndexLOD ? null : o.b.LoadExtensionAsync(e, t, this.name, function (e, o) {
            var s, l = i._getLODs(e, t, i._loader.gltf.materials, o.ids);
            i._loader.logOpen("" + e);
            for (var u = function (e) {
                ...
                var o = i._loader._loadMaterialAsync("#/materials/" + t.index, t, n, r, function (t) {
                  ...
                  if (0 !== e) {
                    a(t);
                    var n = l[e - 1]._data;
                    n[r] && (n[r].babylonMaterial.dispose(), delete n[r])
                  }
                  return t
                });
                0 === e ? s = o : i._materialIndexLOD = null, i._materialPromiseLODs[e] = i._materialPromiseLODs[e] || [], i._materialPromiseLODs[e].push(o)
          ...
          if (null !== this._materialIndexLOD) {
            ...
            var a = this._materialIndexLOD - 1;
            ...
            for (var t = 0, n = e; t < n.length; t++) {
              ...
              if (r._data)
                for (var o in r._data) {
                  var a = r._data[o];
                  0 === a.babylonMeshes.length && (a.babylonMaterial.dispose(!1, !0), delete r._data[o])
                }
            }
        }, e
      }();
    o.b.RegisterExtension(b, function (e) {
      return new g(e)
    });
    var T = "MSFT_minecraftMesh",
      L = function () {
        function e(e) {
          this.name = T, this.enabled = !0, this._loader = e
        }
        return e.prototype.dispose = function () {
          delete this._loader
        }, e.prototype.loadMaterialPropertiesAsync = function (e, t, n) {
    ...
    o.b.RegisterExtension(T, function (e) {
      return new L(e)
    });
    var E = "MSFT_sRGBFactors",
      x = function () {
        function e(e) {
          this.name = E, this.enabled = !0, this._loader = e
        }
        return e.prototype.dispose = function () {
          delete this._loader
        }, e.prototype.loadMaterialPropertiesAsync = function (e, t, n) {
    ...
    o.b.RegisterExtension(E, function (e) {
      return new x(e)
    ...
    ***************************************************************************** */
    ...
    var h, p = n(0),
      m = function () {
        ...
        return e.SetMatrix = function (e, t, n, r, o) {
          var a = null;
          if ("MODEL" === n.semantic ? a = t.getWorldMatrix() : "PROJECTION" === n.semantic ? a = e.getProjectionMatrix() : "VIEW" === n.semantic ? a = e.getViewMatrix() : "MODELVIEWINVERSETRANSPOSE" === n.semantic ? a = p.Matrix.Transpose(t.getWorldMatrix().multiply(e.getViewMatrix()).invert()) : "MODELVIEW" === n.semantic ? a = t.getWorldMatrix().multiply(e.getViewMatrix()) : "MODELVIEWPROJECTION" === n.semantic ? a = t.getWorldMatrix().multiply(e.getTransformMatrix()) : "MODELINVERSE" === n.semantic ? a = t.getWorldMatrix().invert() : "VIEWINVERSE" === n.semantic ? a = e.getViewMatrix().invert() : "PROJECTIONINVERSE" === n.semantic ? a = e.getProjectionMatrix().invert() : "MODELVIEWINVERSE" === n.semantic ? a = t.getWorldMatrix().multiply(e.getViewMatrix()).invert() : "MODELVIEWPROJECTIONINVERSE" === n.semantic ? a = t.getWorldMatrix().multiply(e.getTransformMatrix()).invert() : "MODELINVERSETRANSPOSE" === n.semantic && (a = p.Matrix.Transpose(t.getWorldMatrix().invert())), a) switch (n.type) {
            case s.FLOAT_MAT2:
              o.setMatrix2x2(r, p.Matrix.GetAsMatrix2x2(a));
              break;
            case s.FLOAT_MAT3:
              o.setMatrix3x3(r, p.Matrix.GetAsMatrix3x3(a));
              break;
            case s.FLOAT_MAT4:
              o.setMatrix(r, a)
          }
          ...
          switch (r) {
            ...
            case s.FLOAT_VEC2:
              return e.setVector2(t, p.Vector2.FromArray(n)), !0;
            case s.FLOAT_VEC3:
              return e.setVector3(t, p.Vector3.FromArray(n)), !0;
            case s.FLOAT_VEC4:
              return e.setVector4(t, p.Vector4.FromArray(n)), !0;
            default:
              return !1
          }
        }, e.GetWrapMode = function (e) {
          switch (e) {
            case l.CLAMP_TO_EDGE:
              return p.Texture.CLAMP_ADDRESSMODE;
            case l.MIRRORED_REPEAT:
              return p.Texture.MIRROR_ADDRESSMODE;
            case l.REPEAT:
            default:
              return p.Texture.WRAP_ADDRESSMODE
          }
          ...
          switch (e) {
            case u.LINEAR:
            case u.LINEAR_MIPMAP_NEAREST:
            case u.LINEAR_MIPMAP_LINEAR:
              return p.Texture.TRILINEAR_SAMPLINGMODE;
            case u.NEAREST:
            case u.NEAREST_MIPMAP_NEAREST:
              return p.Texture.NEAREST_SAMPLINGMODE;
            default:
              return p.Texture.BILINEAR_SAMPLINGMODE
          }
        }, e.GetBufferFromBufferView = function (e, t, n, r, o) {
          n = t.byteOffset + n;
          var i = e.loadedBufferViews[t.buffer];
          if (n + r > i.byteLength) throw new Error("Buffer access is out of range");
          var s = i.buffer;
          switch (n += i.byteOffset, o) {
            case a.BYTE:
              return new Int8Array(s, n, r);
            case a.UNSIGNED_BYTE:
              return new Uint8Array(s, n, r);
            case a.SHORT:
              return new Int16Array(s, n, r);
            case a.UNSIGNED_SHORT:
              return new Uint16Array(s, n, r);
            default:
              return new Float32Array(s, n, r)
          }
          ...
          if (!e._DefaultMaterial) {
            p.Effect.ShadersStore.GLTFDefaultMaterialVertexShader = ["precision highp float;", "", "uniform mat4 worldView;", "uniform mat4 projection;", "", "attribute vec3 position;", "", "void main(void)", "{", "    gl_Position = projection * worldView * vec4(position, 1.0);", "}"].join("\n"), p.Effect.ShadersStore.GLTFDefaultMaterialPixelShader = ["precision highp float;", "", "uniform vec4 u_emission;", "", "void main(void)", "{", "    gl_FragColor = u_emission;", "}"].join("\n");
            var n = {
              attributes: ["position"],
            ...
            e._DefaultMaterial = new p.ShaderMaterial("GLTFDefaultMaterial", t, {
              vertex: "GLTFDefaultMaterial",
              fragment: "GLTFDefaultMaterial"
            }, n), e._DefaultMaterial.setColor4("u_emission", new p.Color4(.5, .5, .5, 1))
          }
    ...
    var y = function () {
        ...
        return e.prototype.getNextToken = function () {
          if (this.isEnd()) return h.END_OF_INPUT;
          if (this.currentString = this.read(), this.currentToken = h.UNKNOWN, "_" === this.currentString || this.isLetterOrDigitPattern.test(this.currentString))
            for (this.currentToken = h.IDENTIFIER, this.currentIdentifier = this.currentString; !this.isEnd() && (this.isLetterOrDigitPattern.test(this.currentString = this.peek()) || "_" === this.currentString);) this.currentIdentifier += this.currentString, this.forward();
      ...
      A = ["world", "view", "projection", "worldView", "worldViewProjection", "mBones"],
      b = ["translation", "rotation", "scale"],
      ...
      L = function (e) {
        if (e)
          for (var t = 0; t < e.length / 2; t++) e[2 * t + 1] = 1 - e[2 * t + 1]
      },
      E = function (e) {
      ...
      x = function (e) {
        ...
        if (e.translation || e.rotation || e.scale) {
          var n = p.Vector3.FromArray(e.scale || [1, 1, 1]),
            r = p.Quaternion.FromArray(e.rotation || [0, 0, 0, 1]),
            o = p.Vector3.FromArray(e.translation || [0, 0, 0]);
          t = p.Matrix.Compose(n, r, o)
        } else t = p.Matrix.FromArray(e.matrix);
        return t
      },
      O = function (e, t, n, r) {
          ...
          if (s.jointName) {
            ...
            for (o = 0; o < l.length; o++) {
              ...
              if (u.jointName && u.jointName === n) {
                var c = x(s),
                  f = new p.Bone(s.name || "", r, O(e, t, s.jointName, r), c);
                return f.id = i, f
              }
            }
          }
      ...
      N = function (e, t, n, r, o) {
        if (r || (r = new p.Skeleton(t.name || "", "", e.scene)), !t.babylonSkeleton) return r;
        var a = [],
          i = [];
        ! function (e, t, n, r) {
          for (var o in e.nodes) {
            var a = e.nodes[o],
              i = o;
            if (a.jointName && !w(n, a.jointName)) {
              var s = x(a),
                l = new p.Bone(a.name || "", t, null, s);
              l.id = i, r.push({
                bone: l,
                node: a,
                id: i
          ...
          for (var u = 0; u < r.length; u++)
            for (var c = r[u], f = c.node.children, d = 0; d < f.length; d++) {
              for (var h = null, m = 0; m < r.length; m++)
                if (r[m].id === f[d]) {
                  h = r[m];
                  break
          ...
          if (b = S(e, t.jointNames[s])) {
            ...
            if (l) {
              ...
              if (u) r.bones.push(u);
                ...
                for (var c = !1, f = null, d = 0; d < s; d++) {
                  var h = S(e, t.jointNames[d]);
                  if (h) {
                    var m = h.node;
                    if (m) {
                      var _ = m.children;
                      if (_) {
                        ...
                        for (var y = 0; y < _.length; y++)
                          if (_[y] === o) {
                            f = O(e, t, t.jointNames[d], r), c = !0;
                            break
                          } if (c) break
                      }
                    } else p.Tools.Warn("Joint named " + t.jointNames[d] + " does not exist when looking for parent")
                  }
                }
                var v = x(l);
                !f && a.length > 0 && (f = M(a, o)) && -1 === i.indexOf(f) && i.push(f), new p.Bone(l.jointName || "", r, f, v).id = o
              }
            } else p.Tools.Warn("Joint named " + t.jointNames[s] + " does not exist")
          }
        }
        var A = r.bones;
        r.bones = [];
        ...
        r.prepare();
        for (s = 0; s < i.length; s++) r.bones.push(i[s]);
        return r
      },
      P = function (e, t, n, r, o) {
        if (o || ((o = new p.Mesh(t.name || "", e.scene)).id = r), !t.babylonNode) return o;
        for (var a, i = [], s = null, l = new Array, u = new Array, c = new Array, f = new Array, d = 0; d < n.length; d++) {
          var h = n[d];
          if (I = e.meshes[h])
            for (var y = 0; y < I.primitives.length; y++) {
              var v = new p.VertexData,
                A = I.primitives[y];
              A.mode;
              var b = A.attributes,
                g = null,
                T = null;
              for (var E in b)
                if (g = e.accessors[b[E]], T = m.GetBufferFromAccessor(e, g), "NORMAL" === E) v.normals = new Float32Array(T.length), v.normals.set(T);
                else if ("POSITION" === E) {
                if (_.GLTFFileLoader.HomogeneousCoordinates) {
                  v.positions = new Float32Array(T.length - T.length / 4);
                  for (var x = 0; x < T.length; x += 4) v.positions[x] = T[x], v.positions[x + 1] = T[x + 1], v.positions[x + 2] = T[x + 2]
                } else v.positions = new Float32Array(T.length), v.positions.set(T);
                u.push(v.positions.length)
              } else if (-1 !== E.indexOf("TEXCOORD_")) {
                var O = Number(E.split("_")[1]),
                  M = p.VertexBuffer.UVKind + (0 === O ? "" : O + 1),
                  S = new Float32Array(T.length);
                S.set(T), L(S), v.set(S, M)
              } else "JOINT" === E ? (v.matricesIndices = new Float32Array(T.length), v.matricesIndices.set(T)) : "WEIGHT" === E ? (v.matricesWeights = new Float32Array(T.length), v.matricesWeights.set(T)) : "COLOR" === E && (v.colors = new Float32Array(T.length), v.colors.set(T));
              if (g = e.accessors[A.indices]) T = m.GetBufferFromAccessor(e, g), v.indices = new Int32Array(T.length), v.indices.set(T), f.push(v.indices.length);
              else {
                var w = [];
                for (x = 0; x < v.positions.length / 3; x++) w.push(x);
                v.indices = new Int32Array(w), f.push(v.indices.length)
              }
              s ? s.merge(v) : s = v;
              var N = e.scene.getMaterialByID(A.material);
              i.push(null === N ? m.GetDefaultMaterial(e.scene) : N), l.push(0 === l.length ? 0 : l[l.length - 1] + u[u.length - 2]), c.push(0 === c.length ? 0 : c[c.length - 1] + f[f.length - 2])
            }
        }
        i.length > 1 ? (a = new p.MultiMaterial("multimat" + r, e.scene)).subMaterials = i : a = new p.StandardMaterial("multimat" + r, e.scene), 1 === i.length && (a = i[0]), o.material || (o.material = a), new p.Geometry(r, e.scene, s, !1, o), o.computeWorldMatrix(!0), o.subMeshes = [];
        var P = 0;
        for (d = 0; d < n.length; d++) {
          var I;
          h = n[d];
          if (I = e.meshes[h])
            for (y = 0; y < I.primitives.length; y++) I.primitives[y].mode, p.SubMesh.AddToMesh(P, l[P], u[P], c[P], f[P], o, o, !0), P++
        }
        return o
      },
      I = function (e, t, n, r) {
      ...
      C = function (e, t, n, r) {
        ...
        if (t.skin) {
          if (t.meshes) {
            ...
            (i = P(e, t, t.meshes, n, t.babylonNode)).skeleton = e.scene.getLastSkeletonByID(t.skin), null === i.skeleton && (i.skeleton = N(e, a, 0, a.babylonSkeleton, t.skin), a.babylonSkeleton || (a.babylonSkeleton = i.skeleton)), o = i
          }
        } else if (t.meshes) {
          var i;
          o = i = P(e, t, t.mesh ? [t.mesh] : t.meshes, n, t.babylonNode)
        } else if (!t.light || t.babylonNode || e.importOnlyMeshes) {
          if (t.camera && !t.babylonNode && !e.importOnlyMeshes) {
            var s = e.cameras[t.camera];
            if (s)
              if ("orthographic" === s.type) {
                var l = new p.FreeCamera(t.camera, p.Vector3.Zero(), e.scene, !1);
                l.name = t.name || "", l.mode = p.Camera.ORTHOGRAPHIC_CAMERA, l.attachControl(e.scene.getEngine().getRenderingCanvas()), o = l
              } else if ("perspective" === s.type) {
              var u = s[s.type],
                c = new p.FreeCamera(t.camera, p.Vector3.Zero(), e.scene, !1);
          ...
          var f = e.lights[t.light];
          if (f)
            if ("ambient" === f.type) {
              var d = f[f.type],
                h = new p.HemisphericLight(t.light, p.Vector3.Zero(), e.scene);
              h.name = t.name || "", d.color && (h.diffuse = p.Color3.FromArray(d.color)), o = h
            } else if ("directional" === f.type) {
            var m = f[f.type],
              _ = new p.DirectionalLight(t.light, p.Vector3.Zero(), e.scene);
            _.name = t.name || "", m.color && (_.diffuse = p.Color3.FromArray(m.color)), o = _
          } else if ("point" === f.type) {
            var y = f[f.type],
              v = new p.PointLight(t.light, p.Vector3.Zero(), e.scene);
            v.name = t.name || "", y.color && (v.diffuse = p.Color3.FromArray(y.color)), o = v
          } else if ("spot" === f.type) {
            var A = f[f.type],
              b = new p.SpotLight(t.light, p.Vector3.Zero(), p.Vector3.Zero(), 0, 0, e.scene);
            b.name = t.name || "", A.color && (b.diffuse = p.Color3.FromArray(A.color)), A.fallOfAngle && (b.angle = A.fallOfAngle), A.fallOffExponent && (b.exponent = A.fallOffExponent), o = b
          }
        }
        if (!t.jointName) {
          if (t.babylonNode) return t.babylonNode;
          if (null === o) {
            var g = new p.Mesh(t.name || "", e.scene);
            t.babylonNode = g, o = g
          }
        }
        if (null !== o) {
          if (t.matrix && o instanceof p.Mesh) ! function (e, t, n) {
            if (t.matrix) {
              var r = new p.Vector3(0, 0, 0),
                o = new p.Quaternion,
                a = new p.Vector3(0, 0, 0);
              p.Matrix.FromArray(t.matrix).decompose(a, o, r), I(e, r, o, a)
            } else t.translation && t.rotation && t.scale && I(e, p.Vector3.FromArray(t.translation), p.Quaternion.FromArray(t.rotation), p.Vector3.FromArray(t.scale));
            e.computeWorldMatrix(!0)
          }(o, t);
          else {
            var T = t.translation || [0, 0, 0],
              L = t.rotation || [0, 0, 0, 1],
              E = t.scale || [1, 1, 1];
            I(o, p.Vector3.FromArray(T), p.Quaternion.FromArray(L), p.Vector3.FromArray(E))
          }
      ...
      R = function (e, t, n, r) {
        ...
        var o = e.nodes[t],
          a = null;
        if (r = !(e.importOnlyMeshes && !r && e.importMeshesNames) || (-1 !== e.importMeshesNames.indexOf(o.name || "") || 0 === e.importMeshesNames.length), !o.jointName && r && null !== (a = C(e, o, t)) && (a.id = t, a.parent = n), o.children)
          for (var i = 0; i < o.children.length; i++) R(e, o.children[i], a, r)
      },
      F = function (e) {
        var t = e.currentScene;
        if (t)
          for (var n = 0; n < t.nodes.length; n++) R(e, t.nodes[n], null);
        else
          for (var r in e.scenes) {
            t = e.scenes[r];
            for (n = 0; n < t.nodes.length; n++) R(e, t.nodes[n], null)
          }! function (e) {
            for (var t in e.animations) {
              var n = e.animations[t];
              if (n.channels && n.samplers)
                for (var r = null, o = 0; o < n.channels.length; o++) {
                  var a = n.channels[o],
                  ...
                  if (i) {
                    ...
                    var u = m.GetBufferFromAccessor(e, e.accessors[s]),
                      c = m.GetBufferFromAccessor(e, e.accessors[l]),
                      f = a.target.id,
                      d = e.scene.getNodeByID(f);
                    if (null === d && (d = e.scene.getNodeByName(f)), null !== d) {
                      var h = d instanceof p.Bone,
                        _ = a.target.path,
                        y = b.indexOf(_); - 1 !== y && (_ = g[y]);
                      var v = p.Animation.ANIMATIONTYPE_MATRIX;
                      h || ("rotationQuaternion" === _ ? (v = p.Animation.ANIMATIONTYPE_QUATERNION, d.rotationQuaternion = new p.Quaternion) : v = p.Animation.ANIMATIONTYPE_VECTOR3);
                      var A = null,
                        T = [],
                        L = 0,
                        E = !1;
                      h && r && r.getKeys().length === u.length && (A = r, E = !0), E || (A = new p.Animation(t, h ? "_matrix" : _, 1, v, p.Animation.ANIMATIONLOOPMODE_CYCLE));
                      for (var x = 0; x < u.length; x++) {
                        var O = null;
                        if ("rotationQuaternion" === _ ? (O = p.Quaternion.FromArray([c[L], c[L + 1], c[L + 2], c[L + 3]]), L += 4) : (O = p.Vector3.FromArray([c[L], c[L + 1], c[L + 2]]), L += 3), h) {
                          var M = d,
                            S = p.Vector3.Zero(),
                            w = new p.Quaternion,
                            N = p.Vector3.Zero(),
                            P = M.getBaseMatrix();
                          E && r && (P = r.getKeys()[x].value), P.decompose(N, w, S), "position" === _ ? S = O : "rotationQuaternion" === _ ? w = O : N = O, O = p.Matrix.Compose(N, w, S)
                        }
                        E ? r && (r.getKeys()[x].value = O) : T.push({
                          frame: u[x],
                          value: O
                        })
                      }!E && A && (A.setKeys(T), d.animations.push(A)), r = A, e.scene.stopAnimation(d), e.scene.beginAnimation(d, 0, u[u.length - 1], !0, 1)
                    } else p.Tools.Warn("Creating animation named " + t + ". But cannot find node named " + f + " to attach to")
                  }
                }
            }
          }(e);
      ...
      V = function (e, t, n, r, o, a) {
        return function (i) {
          ! function (e, t, n, r, o) {
            var a = r.values || n.parameters,
              i = n.uniforms;
            for (var l in o) {
              var u = o[l],
                c = u.type,
                f = a[i[l]];
              if (void 0 === f && (f = u.value), f) {
                var d = function (e) {
                  return function (n) {
                    u.value && e && (t.setTexture(e, n), delete o[e])
                  }
                };
                c === s.SAMPLER_2D ? k.LoadTextureAsync(e, r.values ? f : u.value, d(l), function () {
                  return d(null)
                }) : u.value && m.SetUniform(t, l, r.values ? f : u.value, c) && delete o[l]
              }
            }
          }(e, t, n, r, o), t.onBind = function (i) {
            ! function (e, t, n, r, o, a, i) {
              var l = a.values || o.parameters;
              for (var u in n) {
                var c = n[u],
                  f = c.type;
                if (f === s.FLOAT_MAT2 || f === s.FLOAT_MAT3 || f === s.FLOAT_MAT4)
                  if (!c.semantic || c.source || c.node) {
                    if (c.semantic && (c.source || c.node)) {
                      var d = t.scene.getNodeByName(c.source || c.node || "");
                      if (null === d && (d = t.scene.getNodeByID(c.source || c.node || "")), null === d) continue;
                      m.SetMatrix(t.scene, d, c, u, r.getEffect())
                    }
                  } else m.SetMatrix(t.scene, e, c, u, r.getEffect());
                else {
                  var h = l[o.uniforms[u]];
                  if (!h) continue;
                  if (f === s.SAMPLER_2D) {
                    var p = t.textures[a.values ? h : c.value].babylonTexture;
                    if (null == p) continue;
                    r.getEffect().setTexture(u, p)
                  } else m.SetUniform(r.getEffect(), u, h, f)
                }
              }
              i(r)
            }(i, e, o, t, n, r, a)
      ...
      D = function (e, t, n) {
        for (var r in t.uniforms) {
          ...
          if (e.currentIdentifier === r && a.semantic && !a.source && !a.node) {
            ...
            if (-1 !== i) return delete n[r], A[i]
          }
        }
        return e.currentIdentifier
      },
      B = function (e) {
        for (var t in e.materials) k.LoadMaterialAsync(e, t, function (e) {}, function () {})
      },
      G = function () {
        function e() {}
        return e.CreateRuntime = function (e, t, n) {
          ...
          return e.extensions && T(e.extensions, "extensions", r), e.extensionsUsed && T(e.extensionsUsed, "extensionsUsed", r), e.buffers && function (e, t) {
            for (var n in e) {
              var r = e[n];
              t.buffers[n] = r, t.buffersCount++
            }
          }(e.buffers, r), e.bufferViews && T(e.bufferViews, "bufferViews", r), e.accessors && T(e.accessors, "accessors", r), e.meshes && T(e.meshes, "meshes", r), e.lights && T(e.lights, "lights", r), e.cameras && T(e.cameras, "cameras", r), e.nodes && T(e.nodes, "nodes", r), e.images && T(e.images, "images", r), e.textures && T(e.textures, "textures", r), e.shaders && function (e, t) {
            for (var n in e) {
              var r = e[n];
          ...
          var a = e.buffers[t];
          p.Tools.IsBase64(a.uri) ? setTimeout(function () {
            return n(new Uint8Array(p.Tools.DecodeBase64(a.uri)))
          }) : p.Tools.LoadFile(e.rootUrl + a.uri, function (e) {
          ...
          var a = e.textures[t];
          if (a.babylonTexture) r(a.babylonTexture);
          else {
            var i = e.samplers[a.sampler],
              s = i.minFilter === u.NEAREST_MIPMAP_NEAREST || i.minFilter === u.NEAREST_MIPMAP_LINEAR || i.minFilter === u.LINEAR_MIPMAP_NEAREST || i.minFilter === u.LINEAR_MIPMAP_LINEAR,
              l = p.Texture.BILINEAR_SAMPLINGMODE,
              c = null == n ? new Blob : new Blob([n]),
              f = URL.createObjectURL(c),
              d = function () {
                return URL.revokeObjectURL(f)
              },
              h = new p.Texture(f, e.scene, !s, !0, l, d, d);
            void 0 !== i.wrapS && (h.wrapU = m.GetWrapMode(i.wrapS)), void 0 !== i.wrapT && (h.wrapV = m.GetWrapMode(i.wrapT)), h.name = t, a.babylonTexture = h, r(h)
          }
        }, e.LoadShaderStringAsync = function (e, t, n, r) {
          var o = e.shaders[t];
          if (p.Tools.IsBase64(o.uri)) {
            var a = atob(o.uri.split(",")[1]);
            n && n(a)
          } else p.Tools.LoadFile(e.rootUrl + o.uri, n, void 0, void 0, !1, function (e) {
          ...
          if (o.technique) {
            ...
            if (!a) {
              var i = new p.StandardMaterial(t, e.scene);
              return i.diffuseColor = new p.Color3(.5, .5, .5), i.sideOrientation = p.Material.CounterClockWiseSideOrientation, void n(i)
            }
            var l = e.programs[a.program],
              u = a.states,
              c = p.Effect.ShadersStore[l.vertexShader + "VertexShader"],
              m = p.Effect.ShadersStore[l.fragmentShader + "PixelShader"],
              _ = "",
              b = "",
              g = new y(c),
              T = new y(m),
            ...
            for (var S in a.uniforms) {
              var w = a.uniforms[S],
                N = a.parameters[w];
              if (L[S] = N, !N.semantic || N.node || N.source) N.type === s.SAMPLER_2D ? M.push(S) : x.push(S);
              else {
                var P = v.indexOf(N.semantic); - 1 !== P ? (x.push(A[P]), delete L[S]) : x.push(S)
              }
            }
            for (var I in a.attributes) {
              var C = a.attributes[I];
              if ((B = a.parameters[C]).semantic) {
                var R = E(B);
                R && O.push(R)
              }
            }
            for (; !g.isEnd() && g.getNextToken();) {
              if (g.currentToken === h.IDENTIFIER) {
                var F = !1;
                for (var I in a.attributes) {
                  C = a.attributes[I];
                  var B = a.parameters[C];
                  if (g.currentIdentifier === I && B.semantic) {
                    _ += E(B), F = !0;
                    break
                  }
                }
                F || (_ += D(g, a, L))
              } else _ += g.currentString
            }
            for (; !T.isEnd() && T.getNextToken();) {
              T.currentToken === h.IDENTIFIER ? b += D(T, a, L) : b += T.currentString
            }
            var G = {
      ...
      U = function () {
        ...
        return e.RegisterExtension = function (t) {
          e.Extensions[t.name] ? p.Tools.Error('Tool with the same name "' + t.name + '" already exists') : e.Extensions[t.name] = t
        }, e.prototype.dispose = function () {}, e.prototype._importMeshAsync = function (e, t, n, r, o, a, i) {
          var s = this;
          return t.useRightHandedSystem = !0, k.LoadRuntimeAsync(t, n, r, function (t) {
            t.importOnlyMeshes = !0, "" === e ? t.importMeshesNames = [] : "string" == typeof e ? t.importMeshesNames = [e] : !e || e instanceof Array ? (t.importMeshesNames = [], p.Tools.Warn("Argument meshesNames must be of type string or string[]")) : t.importMeshesNames = [e], s._createNodes(t);
            var n = new Array,
              r = new Array;
            for (var i in t.nodes) {
              var l = t.nodes[i];
              l.babylonNode instanceof p.AbstractMesh && n.push(l.babylonNode)
            }
            for (var u in t.skins) {
              var c = t.skins[u];
              c.babylonSkeleton instanceof p.Skeleton && r.push(c.babylonSkeleton)
            }
            s._loadBuffersAsync(t, function () {
              s._loadShadersAsync(t, function () {
                B(t), F(t), !_.GLTFFileLoader.IncrementalLoading && o && o(n, r)
              })
            }, a), _.GLTFFileLoader.IncrementalLoading && o && o(n, r)
          }, i), !0
        }, e.prototype.importMeshAsync = function (e, t, n, r, o) {
          var a = this;
          return new Promise(function (i, s) {
            a._importMeshAsync(e, t, n, r, function (e, t) {
              i({
                meshes: e,
                particleSystems: [],
                skeletons: t,
          ...
          var i = this;
          e.useRightHandedSystem = !0, k.LoadRuntimeAsync(e, t, n, function (e) {
            k.LoadRuntimeExtensionsAsync(e, function () {
              i._createNodes(e), i._loadBuffersAsync(e, function () {
                i._loadShadersAsync(e, function () {
                  B(e), F(e), _.GLTFFileLoader.IncrementalLoading || r()
                })
              }), _.GLTFFileLoader.IncrementalLoading && r()
            }, a)
          }, a)
          ...
          var n = !1,
            r = function (n, r) {
              k.LoadShaderStringAsync(e, n, function (o) {
                o instanceof ArrayBuffer || (e.loadedShaderCount++, o && (p.Effect.ShadersStore[n + (r.type === i.VERTEX ? "VertexShader" : "PixelShader")] = o), e.loadedShaderCount === e.shaderscount && t())
              }, function () {
                p.Tools.Error("Error when loading shader program named " + n + " located at " + r.uri)
              })
            };
          for (var o in e.shaders) {
            n = !0;
            var a = e.shaders[o];
            a ? r.bind(this, o, a)() : p.Tools.Error("No shader named: " + o)
          }
          n || t()
        }, e.prototype._loadBuffersAsync = function (e, t, n) {
          var r = !1,
            o = function (n, r) {
              k.LoadBufferAsync(e, n, function (o) {
                e.loadedBufferCount++, o && (o.byteLength != e.buffers[n].byteLength && p.Tools.Error("Buffer named " + n + " is length " + o.byteLength + ". Expected: " + r.byteLength), e.loadedBufferViews[n] = o), e.loadedBufferCount === e.buffersCount && t()
              }, function () {
                p.Tools.Error("Error when loading buffer named " + n + " located at " + r.uri)
              })
            };
          for (var a in e.buffers) {
            r = !0;
            var i = e.buffers[a];
            i ? o.bind(this, a, i)() : p.Tools.Error("No buffer named: " + a)
          }
          r || t()
      ...
      k = function () {
        ...
        return Object.defineProperty(e.prototype, "name", {
          ...
          e.ApplyExtensions(function (e) {
            ...
            setTimeout(function () {
              o && o(G.CreateRuntime(n.json, t, r))
            })
          })
    ...
    var j = function (e) {
      ...
      return o(t, e), t.prototype.loadRuntimeAsync = function (e, t, n, r, o) {
        var a = t.json.extensionsUsed;
        return !(!a || -1 === a.indexOf(this.name) || !t.bin) && (this._bin = t.bin, r(G.CreateRuntime(t.json, e, n)), !0)
        ...
        return n(m.GetBufferFromBufferView(e, l, 0, l.byteLength, a.UNSIGNED_BYTE)), !0
      }, t.prototype.loadShaderStringAsync = function (e, t, n, r) {
        var o = e.shaders[t];
        if (!(o.extensions && this.name in o.extensions)) return !1;
        var i = o.extensions[this.name],
          s = e.bufferViews[i.bufferView],
          l = m.GetBufferFromBufferView(e, s, 0, s.byteLength, a.UNSIGNED_BYTE);
        return setTimeout(function () {
          var e = m.DecodeBufferToText(l);
          n(e)
        }), !0
      }, t
    }(k);
    U.RegisterExtension(new j);
    var H = function (e) {
      function t() {
        return e.call(this, "KHR_materials_common") || this
      }
      return o(t, e), t.prototype.loadRuntimeExtensionsAsync = function (e, t, n) {
        ...
        if (o)
          for (var a in o) {
            ...
            switch (i.type) {
              case "ambient":
                var s = new p.HemisphericLight(i.name, new p.Vector3(0, 1, 0), e.scene),
                  l = i.ambient;
                l && (s.diffuse = p.Color3.FromArray(l.color || [1, 1, 1]));
                break;
              case "point":
                var u = new p.PointLight(i.name, new p.Vector3(10, 10, 10), e.scene),
                  c = i.point;
                c && (u.diffuse = p.Color3.FromArray(c.color || [1, 1, 1]));
                break;
              case "directional":
                var f = new p.DirectionalLight(i.name, new p.Vector3(0, -1, 0), e.scene),
                  d = i.directional;
                d && (f.diffuse = p.Color3.FromArray(d.color || [1, 1, 1]));
                break;
              case "spot":
                var h = i.spot;
                if (h) new p.SpotLight(i.name, new p.Vector3(0, 10, 0), new p.Vector3(0, -1, 0), h.fallOffAngle || Math.PI, h.fallOffExponent || 0, e.scene).diffuse = p.Color3.FromArray(h.color || [1, 1, 1]);
                break;
              default:
                p.Tools.Warn('GLTF Material Common extension: light type "' + i.type + "â€ not supported")
            }
          }
        return !1
        ...
        if (!a) return !1;
        var i = new p.StandardMaterial(t, e.scene);
        return i.sideOrientation = p.Material.CounterClockWiseSideOrientation, "CONSTANT" === a.technique && (i.disableLighting = !0), i.backFaceCulling = void 0 !== a.doubleSided && !a.doubleSided, i.alpha = void 0 === a.values.transparency ? 1 : a.values.transparency, i.specularPower = void 0 === a.values.shininess ? 0 : a.values.shininess, "string" == typeof a.values.ambient ? this._loadTexture(e, a.values.ambient, i, "ambientTexture", r) : i.ambientColor = p.Color3.FromArray(a.values.ambient || [0, 0, 0]), "string" == typeof a.values.diffuse ? this._loadTexture(e, a.values.diffuse, i, "diffuseTexture", r) : i.diffuseColor = p.Color3.FromArray(a.values.diffuse || [0, 0, 0]), "string" == typeof a.values.emission ? this._loadTexture(e, a.values.emission, i, "emissiveTexture", r) : i.emissiveColor = p.Color3.FromArray(a.values.emission || [0, 0, 0]), "string" == typeof a.values.specular ? this._loadTexture(e, a.values.specular, i, "specularTexture", r) : i.specularColor = p.Color3.FromArray(a.values.specular || [0, 0, 0]), !0
      }, t.prototype._loadTexture = function (e, t, n, r, o) {
        G.LoadTextureBufferAsync(e, t, function (a) {
          G.CreateTextureAsync(e, t, a, function (e) {
            return n[r] = e
          }, o)
        }, o)
      }, t
    }(k);
    U.RegisterExtension(new H), n.d(t, "GLTFBinaryExtension", function () {
      return j
    ...
    var r = n(0),
      o = function () {
        ...
        return e.prototype.parseMTL = function (t, n, o) {
          if (!(n instanceof ArrayBuffer)) {
            for (var a, i = n.split("\n"), s = /\s+/, l = null, u = 0; u < i.length; u++) {
              var c = i[u].trim();
              if (0 !== c.length && "#" !== c.charAt(0)) {
                var f = c.indexOf(" "),
                  d = f >= 0 ? c.substring(0, f) : c;
                d = d.toLowerCase();
                var h = f >= 0 ? c.substring(f + 1).trim() : "";
                "newmtl" === d ? (l && this.materials.push(l), l = new r.StandardMaterial(h, t)) : "kd" === d && l ? (a = h.split(s, 3).map(parseFloat), l.diffuseColor = r.Color3.FromArray(a)) : "ka" === d && l ? (a = h.split(s, 3).map(parseFloat), l.ambientColor = r.Color3.FromArray(a)) : "ks" === d && l ? (a = h.split(s, 3).map(parseFloat), l.specularColor = r.Color3.FromArray(a)) : "ke" === d && l ? (a = h.split(s, 3).map(parseFloat), l.emissiveColor = r.Color3.FromArray(a)) : "ns" === d && l ? l.specularPower = parseFloat(h) : "d" === d && l ? l.alpha = parseFloat(h) : "map_ka" === d && l ? l.ambientTexture = e._getTexture(o, h, t) : "map_kd" === d && l ? l.diffuseTexture = e._getTexture(o, h, t) : "map_ks" === d && l ? l.specularTexture = e._getTexture(o, h, t) : "map_ns" === d || ("map_bump" === d && l ? l.bumpTexture = e._getTexture(o, h, t) : "map_d" === d && l && (l.opacityTexture = e._getTexture(o, h, t)))
              }
            }
            l && this.materials.push(l)
          }
        }, e._getTexture = function (e, t, n) {
          if (!t) return null;
          var o = e;
          if ("file:" === e) {
            var i = t.lastIndexOf("\\"); - 1 === i && (i = t.lastIndexOf("/")), o += i > -1 ? t.substr(i + 1) : t
          } else o += t;
          return new r.Texture(o, n, !1, a.INVERT_TEXTURE_Y)
        }, e
      }(),
      a = function () {
        function e(t) {
          this.name = "obj", this.extensions = ".obj", this.obj = /^o/, this.group = /^g/, this.mtllib = /^mtllib /, this.usemtl = /^usemtl /, this.smooth = /^s /, this.vertexPattern = /v( +[\d|\.|\+|\-|e|E]+){3,7}/, this.normalPattern = /vn( +[\d|\.|\+|\-|e|E]+)( +[\d|\.|\+|\-|e|E]+)( +[\d|\.|\+|\-|e|E]+)/, this.uvPattern = /vt( +[\d|\.|\+|\-|e|E]+)( +[\d|\.|\+|\-|e|E]+)/, this.facePattern1 = /f\s+(([\d]{1,}[\s]?){3,})+/, this.facePattern2 = /f\s+((([\d]{1,}\/[\d]{1,}[\s]?){3,})+)/, this.facePattern3 = /f\s+((([\d]{1,}\/[\d]{1,}\/[\d]{1,}[\s]?){3,})+)/, this.facePattern4 = /f\s+((([\d]{1,}\/\/[\d]{1,}[\s]?){3,})+)/, this.facePattern5 = /f\s+(((-[\d]{1,}\/-[\d]{1,}\/-[\d]{1,}[\s]?){3,})+)/, this._meshLoadOptions = t || e.currentMeshLoadOptions
        }
        return Object.defineProperty(e, "currentMeshLoadOptions", {
          get: function () {
            return {
          ...
          return this.importMeshAsync(null, e, t, n).then(function (t) {
            ...
            }), n.removeAllFromScene(), n
          })
        }, e.prototype._parseSolid = function (t, n, a, i) {
          for (var s, l = this, u = [], c = [], f = [], d = [], h = [], p = [], m = [], _ = [], y = [], v = [], A = [], b = 0, g = !1, T = [], L = [], E = [], x = [], O = [], M = "", S = "", w = new o, N = 1, P = !0, I = new r.Color4(.5, .5, .5, 1), C = function (e, t, n, r, o, a, i) {
              var s; - 1 === (s = l._meshLoadOptions.OptimizeWithUV ? function (e, t) {
                e[t[0]] || (e[t[0]] = {
                  normals: [],
                  idx: [],
                  uv: []
              ...
              }(A, [e, n])) ? (p.push(m.length), m.push(r), _.push(o), v.push(a), void 0 !== i && y.push(i), A[e].normals.push(n), A[e].idx.push(b++), l._meshLoadOptions.OptimizeWithUV && A[e].uv.push(t)) : p.push(s)
            }, R = function () {
              for (var e = 0; e < m.length; e++) T.push(m[e].x, m[e].y, m[e].z), E.push(v[e].x, v[e].y, v[e].z), x.push(_[e].x, _[e].y);
              !0 === l._meshLoadOptions.ImportVertexColors && L.push(y[e].r, y[e].g, y[e].b, y[e].a), m = [], v = [], _ = [], y = [], A = [], b = 0
            }, F = function (e, t) {
              t + 1 < e.length && (O.push(e[0], e[t], e[t + 1]), F(e, t += 1))
            }, V = function (e, t) {
              F(e, t);
              for (var n = 0; n < O.length; n++) {
                var o = parseInt(O[n]) - 1;
                C(o, 0, 0, u[o], r.Vector2.Zero(), r.Vector3.Up(), !0 === l._meshLoadOptions.ImportVertexColors ? d[o] : void 0)
              }
              O = []
            }, D = function (e, t) {
              F(e, t);
              for (var n = 0; n < O.length; n++) {
                var o = O[n].split("/"),
                  a = parseInt(o[0]) - 1,
                  i = parseInt(o[1]) - 1;
                C(a, i, 0, u[a], f[i], r.Vector3.Up(), !0 === l._meshLoadOptions.ImportVertexColors ? d[a] : void 0)
              }
              O = []
            }, B = function (e, t) {
              F(e, t);
              ...
              for (var n = 0; n < O.length; n++) {
                var o = O[n].split("//"),
                  a = parseInt(o[0]) - 1,
                  i = parseInt(o[1]) - 1;
                C(a, 1, i, u[a], r.Vector2.Zero(), c[i], !0 === l._meshLoadOptions.ImportVertexColors ? d[a] : void 0)
              }
              O = []
            }, U = function (e, t) {
              F(e, t);
              for (var n = 0; n < O.length; n++) {
                var r = O[n].split("/"),
                  ...
                  a = f.length + parseInt(r[1]),
                  i = c.length + parseInt(r[2]);
                C(o, a, i, u[o], f[a], c[i], !0 === l._meshLoadOptions.ImportVertexColors ? d[o] : void 0)
              }
              O = []
            }, k = function () {
              h.length > 0 && (s = h[h.length - 1], R(), p.reverse(), s.indices = p.slice(), s.positions = T.slice(), s.normals = E.slice(), s.uvs = x.slice(), !0 === l._meshLoadOptions.ImportVertexColors && (s.colors = L.slice()), p = [], T = [], L = [], E = [], x = [])
            }, j = a.split("\n"), H = 0; H < j.length; H++) {
            var W, K = j[H].trim();
            if (0 !== K.length && "#" !== K.charAt(0))
              if (this.vertexPattern.test(K)) W = K.match(/[^ ]+/g), u.push(new r.Vector3(parseFloat(W[1]), parseFloat(W[2]), parseFloat(W[3]))), !0 === this._meshLoadOptions.ImportVertexColors && (W.length >= 7 ? d.push(new r.Color4(parseFloat(W[4]), parseFloat(W[5]), parseFloat(W[6]), 7 === W.length || void 0 === W[7] ? 1 : parseFloat(W[7]))) : d.push(I));
              else if (null !== (W = this.normalPattern.exec(K))) c.push(new r.Vector3(parseFloat(W[1]), parseFloat(W[2]), parseFloat(W[3])));
            else if (null !== (W = this.uvPattern.exec(K))) f.push(new r.Vector2(parseFloat(W[1]) * e.UV_SCALING.x, parseFloat(W[2]) * e.UV_SCALING.y));
            else if (null !== (W = this.facePattern3.exec(K))) B(W[1].trim().split(" "), 1);
            else if (null !== (W = this.facePattern4.exec(K))) G(W[1].trim().split(" "), 1);
            else if (null !== (W = this.facePattern5.exec(K))) U(W[1].trim().split(" "), 1);
            else if (null !== (W = this.facePattern2.exec(K))) D(W[1].trim().split(" "), 1);
            else if (null !== (W = this.facePattern1.exec(K))) V(W[1].trim().split(" "), 1);
            else if (this.group.test(K) || this.obj.test(K)) {
              var Y = {
              ...
              k(), h.push(Y), g = !0, P = !0, N = 1
            } else if (this.usemtl.test(K)) {
              if (M = K.substring(7).trim(), !P) {
                k();
                Y = {
                  name: "_mm" + N.toString(),
                  indices: void 0,
              ...
              g && P && (h[h.length - 1].materialName = M, P = !1)
            } else this.mtllib.test(K) ? S = K.substring(7).trim() : this.smooth.test(K) || console.log("Unhandled expression at line : " + K)
          }
          g && (s = h[h.length - 1], p.reverse(), R(), s.indices = p, s.positions = T, s.normals = E, s.uvs = x, !0 === this._meshLoadOptions.ImportVertexColors && (s.colors = L)), g || (p.reverse(), R(), h.push({
          ...
          for (var Z = [], Q = new Array, J = 0; J < h.length; J++) {
            if (t && h[J].name)
              if (t instanceof Array) {
                if (-1 === t.indexOf(h[J].name)) continue
              } else if (h[J].name !== t) continue;
            s = h[J];
            var X = new r.Mesh(h[J].name, n);
            Q.push(h[J].materialName);
            var q = new r.VertexData;
            if (q.uvs = s.uvs, q.indices = s.indices, q.positions = s.positions, !0 === this._meshLoadOptions.ComputeNormals) {
              var z = new Array;
              r.VertexData.ComputeNormals(s.positions, s.indices, z), q.normals = z
            } else q.normals = s.normals;
            !0 === this._meshLoadOptions.ImportVertexColors && (q.colors = s.colors), q.applyToMesh(X), this._meshLoadOptions.InvertY && (X.scaling.y *= -1), Z.push(X)
          }
          var $ = [];
            ...
            l._loadMTL(S, i, function (o) {
              try {
                ...
                for (var a = 0; a < w.materials.length; a++) {
                  for (var s, u = 0, c = [];
                    (s = Q.indexOf(w.materials[a].name, u)) > -1;) c.push(s), u = s + 1;
                  if (-1 === s && 0 === c.length) w.materials[a].dispose();
                  else
                    for (var f = 0; f < c.length; f++) Z[c[f]].material = w.materials[a]
                }
                e()
              } catch (n) {
        ...
        }, e.OPTIMIZE_WITH_UV = !1, e.INVERT_Y = !1, e.INVERT_TEXTURE_Y = !0, e.IMPORT_VERTEX_COLORS = !1, e.COMPUTE_NORMALS = !1, e.UV_SCALING = new r.Vector2(1, 1), e.SKIP_MATERIALS = !1, e.MATERIAL_LOADING_FAILS_SILENTLY = !0, e
      }();
    r.SceneLoader && r.SceneLoader.RegisterPlugin(new a), n.d(t, "MTLFileLoader", function () {
      return o
      ...
      o = function () {
        ...
        return e.prototype.importMesh = function (e, t, n, o, a, i, s) {
          ...
          if ("string" != typeof n) {
            ...
            for (var c = new Uint8Array(n), f = "", d = 0; d < n.byteLength; d++) f += String.fromCharCode(c[d]);
            n = f
          }
          ...
          return r && (e.createDefaultLight(), e.createDefaultCameraOrLight()), r
        }, e.prototype.loadAssetContainer = function (e, t, n, o) {
          var a = new r.AssetContainer(e);
          return this.importMesh(null, e, t, n, a.meshes, null, null), a.removeAllFromScene(), a
          ...
          for (var n = new DataView(t), o = n.getUint32(80, !0), a = 0, i = new Float32Array(3 * o * 3), s = new Float32Array(3 * o * 3), l = new Uint32Array(3 * o), u = 0, c = 0; c < o; c++) {
            for (var f = 84 + 50 * c, d = n.getFloat32(f, !0), h = n.getFloat32(f + 4, !0), p = n.getFloat32(f + 8, !0), m = 1; m <= 3; m++) {
              var _ = f + 12 * m;
              i[a] = n.getFloat32(_, !0), i[a + 2] = n.getFloat32(_ + 4, !0), i[a + 1] = n.getFloat32(_ + 8, !0), s[a] = d, s[a + 2] = h, s[a + 1] = p, a += 3
            }
            l[u] = u++, l[u] = u++, l[u] = u++
          }
          ...
          for (var n, o = [], a = [], i = [], s = 0; n = this.facetsPattern.exec(t);) {
            ...
            if (this.normalPattern.lastIndex = 0, u) {
              for (var c, f = [Number(u[1]), Number(u[5]), Number(u[3])]; c = this.vertexPattern.exec(l);) o.push(Number(c[1]), Number(c[5]), Number(c[3])), a.push(f[0], f[1], f[2]);
    ...
    r.SceneLoader && r.SceneLoader.RegisterPlugin(new o), n.d(t, "STLFileLoader", function () {
      return o
    })
  }, function (e, t, n) {
    "use strict";
    (function (e) {
      ...
      if (void 0 !== o)
        for (var a in o.BABYLON = o.BABYLON || {}, r) o.BABYLON[a] = r[a]
    }).call(this, n(3))
    ...
    (function (e) {
      ...
      var o = void 0 !== e ? e : "undefined" != typeof window ? window : void 0;
      if (void 0 !== o)
        for (var a in o.BABYLON = o.BABYLON || {}, o.BABYLON.GLTF1 = o.BABYLON.GLTF1 || {}, r) o.BABYLON.GLTF1[a] = r[a]
    }).call(this, n(3))
  }, function (e, t, n) {
    "use strict";
    (function (e) {
      ...
      if (void 0 !== i) {
        ...
        var l = [];
        for (var u in r) s.GLTF2.Loader.Extensions[u] = r[u], l.push(u);
        for (var u in o) s.GLTF2.Loader[u] = o[u], l.push(u);
        for (var u in a) l.indexOf(u) > -1 || (s.GLTF2[u] = a[u])
      }
    }).call(this, n(3))
  }, function (e, t, n) {
    "use strict";
    n.r(t),
      function (e) {
        ...
        var o = void 0 !== e ? e : "undefined" != typeof window ? window : void 0;
        if (void 0 !== o)
          for (var a in r) o.BABYLON[a] = r[a]
      }.call(this, n(3))
  }, function (e, t, n) {
    "use strict";
    n.r(t),
